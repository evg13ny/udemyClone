                  ...
                  <form method="POST">
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        ...
                        <div class="pt-2">
                          <label href="#" class="btn btn-primary btn-sm" title="Upload new profile image"><i class="bi bi-upload text-white"></i><input type="file" name="image" style="display: none;"></label>
