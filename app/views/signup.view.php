                ...
                <div class="card-body">
                  ...
                  <form method="POST" class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      ...
                      <input type="password" name="password" class="form-control <?= !empty($errors['password']) ? 'border-danger' : '' ?>" id="yourPassword" required1>
                    ...
                    <div class="col-12">
                      ...
                      <input type="password" name="retype_password" class="form-control <?= !empty($errors['retype_password']) ? 'border-danger' : '' ?>" id="yourPassword" required1>
